...
import com.mtbp.data.repository.ScreenRepository;
import com.mtbp.data.repository.ScreeningRepository;
import com.mtbp.data.repository.TheatreRepository;
import com.mtbp.data.repository.TicketRepository;
...
public class ScreeningService {
    ...
    public Screening save(MovieScreening movieScreening) {
    	return screeningRepository.save(movieScreening);
